...
<body class="bg-gray-200">
 <div class="flex">
  ...
  @include('tailer.tailersiderbar')
    ...
    <main  class="z-40 ml-70 flex-1 mx-56">
      {{-- show tailershop  --}}
...
<div class="overflow-x-auto relative">
    ...
    <table class="w-full text-sm text-left text-gray-600 mt-10 rounded-md shadow-xl">
       ...
       @foreach ($data as $tailer)
        <tbody>
            <tr class="bg-white border-b">
                ...
                <td class="py-4 px-6">
                    <a href="{{url('updateTailerInfo',$tailer->id)}}" class="text-white bg-indigo-600 hover:bg-indigo-700 font-normal px-1 py-1 hover:underline rounded-sm">Update</a>
                </td>
                <td class="py-4 px-6">
                    <a href="{{url('deletetailerinfo',$tailer->id)}}" class="text-white bg-rose-600 hover:bg-rose-700 font-normal px-1 py-1 hover:underline rounded-sm">Delete</a>
                </td>
            </tr>  
        </tbody>
        @endforeach
