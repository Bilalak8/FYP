...
<div class="overflow-x-auto relative">
    ...
    {{-- <div class="py-4 px-6">
        <p>This is all customer measurment </p>
        <a href="{{url('totalmeasurmentrecord',$tailer->id)}}" class="text-white bg-indigo-600 hover:bg-indigo-700 font-normal px-1 py-1 hover:underline rounded-sm">Customer Measurments</a>
    </div> --}}
    @endforeach
    </div>
</div>
