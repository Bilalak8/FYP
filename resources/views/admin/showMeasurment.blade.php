...
<body class="bg-gray-200">
 <div class="flex">
    ...
    <main  class="z-40 ml-[240px] flex-1 mx-56">
        ...
        @foreach ($data as $tailer)
            <tbody>
                <tr class="bg-white border-b">
                    ...
                    <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap"> {{$tailer->user->name}}</th>
                    <td class="py-4 px-6"> {{$tailer->user->phone}} </td>
                    <td class="py-4 px-6"> {{$tailer->user->address}} </td>
                    <td class="py-4 px-6"> {{$tailer->collar}} </td>
