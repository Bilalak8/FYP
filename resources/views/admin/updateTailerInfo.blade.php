      ...
      <section class="bg-gray-200 text-gray-600 body-font relative">
        <div class="container px-5 py-24 mx-auto ">
          <div class="flex flex-col text-center w-full mb-12">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Update Tailer Detail Info</h1>
          </div>
        ...
        @endif
          ...
          <div class="container flex align-items-center justify-center" >
            <form action="{{url('uploadUpdateTailerInfo',$data->id)}}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="p-2">
            ...
            <div class="p-2">
              ...
              <input type="text" name="loc" value="{{$data->location}}" id="tname" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div> 
            <div class="p-2">
              <label class="leading-7 text-sm text-gray-600" for="phone">Phone</label>
              <input type="number" name="phone" value="{{$data->phone}}" id="loc" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
            <div class="p-2">
                <label class="leading-7 text-sm text-gray-600" for="email">Email</label>
                <input type="email" name="email" value="{{$data->email}}" id="phone" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
              </div>
              <div class="p-2">
                <label class="leading-7 text-sm text-gray-600" for="suit price">Suit Price</label>
                <input type="number" name="suitprice" value="{{$data->suit_price}}" id="suitprice" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
              </div>
              <div class="p-2">
                <label class="leading-7 text-sm text-gray-600" for="delivery time">Delivery Time</label>
                <input type="text" name="deliverytime" value="{{$data->delivery_time}}" id="deliverytime" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
              </div>
              <div class="p-2">
                <label class="leading-7 text-sm text-gray-600" for="services">Services</label>
                <input type="text" name="services" value="{{$data->services}}" id="services" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
              </div>
